...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.users.edit.photo',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Foto'])->syncRoles($role1, $role2);
        Permission::create(['name' => 'admin.users.edit.name',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Nombre'])->syncRoles($role1);
        Permission::create(['name' => 'admin.users.edit.ced',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Cedula'])->syncRoles($role1);
        Permission::create(['name' => 'admin.users.edit.email',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Email'])->syncRoles($role1);
        Permission::create(['name' => 'admin.users.edit.username',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Usuario'])->syncRoles($role1);
        Permission::create(['name' => 'admin.users.edit.password',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Password'])->syncRoles($role1, $role2);
        Permission::create(['name' => 'admin.users.edi.factor',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Doble factor'])->syncRoles($role1);
        Permission::create(['name' => 'admin.users.edit.sessions',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Secciones Abiertas'])->syncRoles($role1, $role2);
        Permission::create(['name' => 'admin.users.edit.delete',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Borrar'])->syncRoles($role1);
        ...
        Permission::create(['name' => 'admin.courses.import',
                            'group_id' => 10,
                            'description' => 'Carga masiva de materias'])->syncRoles($role1);
        ...
        Permission::create(['name' => 'admin.usercourses.analisyscourses',
                            'group_id' => 10,
                            'description' => 'Analisis Profesor (Manual)'])->syncRoles($role1);
        Permission::create(['name' => 'admin.usercourses.analisysusers',
                            'group_id' => 10,
                            'description' => 'Analisis Materia/Profesor (Manual)'])->syncRoles($role1);
