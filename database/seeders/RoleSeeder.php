...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.users.edit.photo',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Foto'])->syncRoles($role1);
        ...
        Permission::create(['name' => 'admin.users.edit.password',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Password'])->syncRoles($role1);
        ...
        Permission::create(['name' => 'admin.users.edit.sessions',
                            'group_id' => 2,
                            'description' => 'Editar usuario - Secciones Abiertas'])->syncRoles($role1);
