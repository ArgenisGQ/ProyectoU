        ...
        <div class="row">
                        ...
                        @foreach ($activities as $activity )
                            ...
                            {{--  <td><a href={{route('activities.show', $activity)}}>{{$activity->id}}</a></td> --}}
                                ...
                                @if ($activity->status == 1)
                                    <td><a href={{route('admin.activities.edit', $activity)}}>{{$activity->name}}</a></td>
                                @else
                                    <td><a href={{route('activities.pdf.down', $activity)}}>{{$activity->name}}</a></td>
                                @endif
                                {{-- <td>{{$activity->name}}</td> --}}
                                @if ($cursoData != 'no')
          ...
          <div class = "row">
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                  <div class="card-header border-transparent">
                    <h3 class="card-title">Actividades Sumativas con ponderacion Cero</h3>
                      ...
                      <table class="table m-0">
                        ...
                        <tbody>
                          ...
                          @foreach ($activities as $activity )
                              ...
                              <tr>
                              {{--  <td><a href={{route('activities.show', $activity)}}>{{$activity->id}}</a></td> --}}
                              @if ($activity->status == 1 && $activity->evaluation == 0 && $activity->activity_type == 3)
                                  <td>{{$activity->id}}</a></td>
                                  <td><a href={{route('admin.activities.edit', $activity)}}>{{$activity->name}}</td>
                                  @if ($cursoData != 'no')
                                      <td>{{$cursoData->course}}</td>
                                  @else
                                      <td>--</td>
                              ...
                              @endif
                              {{-- @else
                                  <td>-no hay cursos sin terminar--</td>
                              @endif --}}
