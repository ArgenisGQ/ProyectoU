...
@section('js')
    ...
    <!-- REQUIRED SCRIPTS -->
    <!-- jQuery -->
    <script src="{{asset('xvendor/dashboard/jquery/jquery.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{asset('xvendor/dashboard/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <!-- overlayScrollbars -->
    <script src="{{asset('vendor/dashboard/overlayScrollbars/js/jquery.overlayScrollbars.min.js')}}"></script>
    <!-- AdminLTE App -->
    <script src="{{asset('xvendor/dashboard/dist/js/adminlte.js')}}"></script>
